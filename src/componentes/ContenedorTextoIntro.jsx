  ...
  return (
    <>
      <div>
        ...
        <p className="text-amber-50 pt-6"></p>
        <p className="text-amber-50 pt-6 text-justify text-sm md:text-md lg:text-lg ">
          <span className="text-orange-600">Nutrición Integral </span> +
          <span className="text-amber-300"> Coaching </span>= ¡RESULTADOS PARA
          TI!
          <br />
          ...
          ofrezco apoyo en <span className="text-amber-300">motivación</span>,
          ...
          <span className="text-amber-300">MEJORES RESULTADOS</span> manteniendo
